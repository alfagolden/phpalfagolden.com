...
$form_to_baserow_map = [
    ...
    'machine_type' => 'نوع المكينة', 'speed' => 'السرعة', 'rails_elevator' => 'سكك الصاعدة', 'rails_counterweight' => 'سكك ثقل الموازنة', 'traction_cables' => 'حبال الجر', 'flexible_cable' => 'الكابل المرن',
    'elevator_frame' => 'الاطار الحامل للصاعدة', 'car_finishing' => 'الصاعدة - التشطيب', 'car_internal_dimensions' => 'الصاعدة - المقاسات الداخلية', 'car_other_contents' => 'الصاعدة - المحتويات الاخرى', 'ceiling' => 'السقف',
    'emergency_lighting' => 'اضاءة الطوارئ', 'car_movement_device' => 'جهاز تحريك الصاعدة', 'flooring' => 'الأرضية',
    'door_operation_method' => 'طريقة تشغيل الأبواب', 'internal_door' => 'الباب الداخلي', 'door_finishing' => 'تشطيب الابواب', 'door_dimensions' => 'مقاسات الابواب',
...
$settings_fields = [
    'elevator_control_system' => 6863, 'operation_method' => 6864, 'stops_naming' => 6865, 'electrical_current' => 6866, 'machine_type' => 6862, 'speed' => 7149, 'rails_elevator' => 6873, 'rails_counterweight' => 6874, 'traction_cables' => 6875, 'flexible_cable' => 6876, 'elevator_frame' => 6877, 'car_finishing' => 6878, 'car_internal_dimensions' => 6879, 'car_other_contents' => 7151, 'ceiling' => 6880, 'emergency_lighting' => 6881, 'car_movement_device' => 6882, 'flooring' => 6883, 'door_operation_method' => 7009, 'internal_door' => 6872, 'door_finishing' => 7150, 'door_dimensions' => 7010, 'cop_panel' => 6885, 'lop_finishing' => 6886, 'lop_main_floor' => 6887, 'lop_other_floors' => 6888, 'safety_electrical_devices' => 6889, 'emergency_devices' => 6890, 'lighting_devices' => 6891, 'safety_devices' => 6892, 'light_curtain' => 6893, 'speed_governor' => 6894, 'shock_absorbers' => 6895, 'travel_end_device' => 6896, 'door_safety_cam' => 6897, 'car_guides' => 6898, 'external_door_switch' => 6899, 'electrical_connections' => 6900
];

$long_text_fields = ['car_internal_dimensions', 'car_other_contents', 'cop_panel', 'lop_other_floors', 'door_dimensions'];

$quote_fields_for_saving = [
    'elevator_control_system' => 6803, 'operation_method' => 6804, 'stops_naming' => 6805, 'electrical_current' => 6806, 'machine_type' => 6802, 'speed' => 7136, 'rails_elevator' => 6813, 'rails_counterweight' => 6814, 'traction_cables' => 6815, 'flexible_cable' => 6816, 'elevator_frame' => 6817, 'car_finishing' => 6818, 'car_internal_dimensions' => 6819, 'car_other_contents' => 7139, 'ceiling' => 6820, 'emergency_lighting' => 6821, 'car_movement_device' => 6822, 'flooring' => 6823, 'door_operation_method' => 6998, 'internal_door' => 7000, 'door_finishing' => 7138, 'door_dimensions' => 6999, 'cop_panel' => 6825, 'lop_finishing' => 6826, 'lop_main_floor' => 6827, 'lop_other_floors' => 6828, 'safety_electrical_devices' => 6829, 'emergency_devices' => 6830, 'lighting_devices' => 6831, 'safety_devices' => 6832, 'light_curtain' => 6833, 'speed_governor' => 6834, 'shock_absorbers' => 6835, 'travel_end_device' => 6836, 'door_safety_cam' => 6837, 'car_guides' => 6838, 'external_door_switch' => 6839, 'electrical_connections' => 6840
];
...
<body>
                ...
                $sections = [
                    ...
                    'car' => [
                        ...
                        'fields' => [
                            ...
                            'car_other_contents' => ['boxes-stacked', 'المحتويات الأخرى'],
                    ...
                    'doors' => [
                        ...
                        'fields' => [
                            ...
                            'door_finishing' => ['paint-roller', 'تشطيب الأبواب'],
    ...
    function showGlobalAlert(message, type = 'info', section = null) {
        ...
        if (section) {
            ...
            const sectionKeys = ['operation', 'components', 'car', 'doors', 'panels', 'safety'];
            const fieldSections = {
                'elevator_control_system': 'operation', 'operation_method': 'operation', 'stops_naming': 'operation', 'electrical_current': 'operation',
                'machine_type': 'components', 'speed': 'components', 'rails_elevator': 'components', 'rails_counterweight': 'components', 'traction_cables': 'components', 'flexible_cable': 'components',
                'elevator_frame': 'car', 'car_finishing': 'car', 'car_internal_dimensions': 'car', 'car_other_contents': 'car', 'ceiling': 'car', 'emergency_lighting': 'car', 'car_movement_device': 'car', 'flooring': 'car',
                'door_operation_method': 'doors', 'internal_door': 'doors', 'door_finishing': 'doors', 'door_dimensions': 'doors',
                'cop_panel': 'panels', 'lop_finishing': 'panels', 'lop_main_floor': 'panels', 'lop_other_floors': 'panels'
            };
            const sectionKey = fieldSections[section] || 'operation';
