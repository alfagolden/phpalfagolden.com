    ...
    try {
        switch ($action) {
            case 'add_category':
                ...
                $data = [[
                    'الاسم' => $_POST['name'],
                    'معرف_القسم' => rand(1000, 9999), // توليد معرف عشوائي
                    'الصورة' => $imageUrl,
                    'الرابط' => '', // حقل فارغ حسب هيكل البيانات
                    'حذف' => 0 // تعيين حذف كـ 0 (غير محذوف)
                ]];
            ...
            case 'add_product':
                ...
                $data = [[
                    ...
                    'الصورة' => $imageUrl,
                    'القسم' => $categoryName, // حسب هيكل البيانات الفعلي
                    'حذف' => 0 // تعيين حذف كـ 0 (غير محذوف)
                ]];
    ...
    try {
        switch ($_GET['api']) {
            ...
            case 'products':
                ...
                $where = "(معرف_القسم,eq,$categoryId)~and(حذف,neq,1)";
